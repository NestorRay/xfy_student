...
.method public static autoConvertDensity(Landroid/app/Activity;FZ)V
    ...
    .line 234
    :goto_9
    invoke-static {v0, v5, v13, v2, v3}, Lme/jessyan/autosize/AutoSize;->setDensity(Landroid/app/Activity;FIFF)V
    ...
    const-string v8, "designWidthInSubunits"

    goto :goto_b

    :cond_b
    const-string v8, "designHeightInSubunits"
