.class public Lcom/xhly/easystud/ui/zuoye/model/ZuoyeDetailTikuModel;
.super Lcom/xhly/easystud/base/BaseModel;
.source "ZuoyeDetailTikuModel.java"

# interfaces
.implements Lcom/xhly/easystud/ui/zuoye/contract/ZuoyeDetailTikuContract$Model;
...
# virtual methods
.method public ps_paper_question(Ljava/lang/Integer;)Lio/reactivex/Flowable;
    .locals 2
    ...
    .line 34
    iget-object p1, p0, Lcom/xhly/easystud/ui/zuoye/model/ZuoyeDetailTikuModel;->mSchoolService:Lcom/xhly/easystud/api/SchoolService;

    invoke-interface {p1, v0}, Lcom/xhly/easystud/api/SchoolService;->ps_paper_question(Ljava/util/Map;)Lio/reactivex/Flowable;
...
.method public ps_start_paper(Ljava/lang/Integer;)Lio/reactivex/Flowable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lcom/xhly/easystud/api/SchoolService;->ps_start_paper(Ljava/util/Map;)Lio/reactivex/Flowable;
...
.method public ps_submit_paper(Ljava/lang/Integer;)Lio/reactivex/Flowable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lcom/xhly/easystud/api/SchoolService;->ps_submit_paper(Ljava/util/Map;)Lio/reactivex/Flowable;
...
.method public ps_submit_question(Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/Integer;)Lio/reactivex/Flowable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lcom/xhly/easystud/api/SchoolService;->ps_submit_question(Ljava/util/Map;)Lio/reactivex/Flowable;
...
.method public uploadfile(Ljava/lang/String;)Lio/reactivex/Flowable;
    ...
    .line 70
    iget-object v0, p0, Lcom/xhly/easystud/ui/zuoye/model/ZuoyeDetailTikuModel;->mFileService:Lcom/xhly/easystud/api/FileService;
