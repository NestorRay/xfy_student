.class public Lcom/baidu/speech/utils/analysis/Analysis;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/baidu/speech/utils/analysis/Analysis$Item;
    }
.end annotation
...
.method static synthetic access$000(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/baidu/speech/utils/analysis/Analysis;->syncUploadAll(Landroid/content/Context;)V

    return-void
.end method

.method public static asyncUploadAll(Landroid/content/Context;)V
    .locals 2

    new-instance v0, Ljava/lang/Thread;

    new-instance v1, Lcom/baidu/speech/utils/analysis/Analysis$1;

    invoke-direct {v1, p0}, Lcom/baidu/speech/utils/analysis/Analysis$1;-><init>(Landroid/content/Context;)V
...
.method private static buildStatUrl(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/speech/utils/Policy;->uid(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/baidu/speech/utils/analysis/Utility;->getSdkVersion()Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/speech/utils/analysis/Utility;->getAppName(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/speech/utils/analysis/Utility;->getPlatform(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/baidu/speech/utils/analysis/Utility;->getOS()Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/speech/utils/analysis/Utility;->getNetType(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lcom/baidu/speech/utils/analysis/Utility;->getScreen(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/baidu/speech/utils/analysis/Utility;->getSdkName()Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/speech/utils/analysis/Utility;->getSignatureMD5(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v0, p0}, Lcom/baidu/speech/utils/analysis/Analysis;->join(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    const-string p1, "http://yuyin.baidu.com/voice?osname=voiceopen&action=usereventflow&"
...
.method private static httpRequest(Ljava/lang/String;Ljava/util/Map;[BZ)Ljava/lang/String;
    .locals 8
...
.method public static log(Landroid/content/Context;Lcom/baidu/speech/utils/analysis/Analysis$Item;)V
    .locals 5
    ...
    const-string v1, "open-analysis"

    invoke-direct {v0, p0, v1}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-virtual {v0}, Ljava/io/File;->mkdirs()Z

    iget p0, p1, Lcom/baidu/speech/utils/analysis/Analysis$Item;->appId:I
    ...
    const-string v1, "appid is 0, ignore "
    ...
    invoke-virtual {p1}, Lcom/baidu/speech/utils/analysis/Analysis$Item;->toString()Ljava/lang/String;
...
.method private static declared-synchronized syncUploadAll(Landroid/content/Context;)V
    .locals 14

    const-class v0, Lcom/baidu/speech/utils/analysis/Analysis;
    ...
    const-string v10, "recog_results"
    ...
    invoke-static {v8}, Lcom/baidu/speech/utils/analysis/Utility;->encryptGZIP(Ljava/lang/String;)[B
    ...
    :cond_1
    invoke-static {v8}, Lcom/baidu/speech/utils/analysis/Utility;->encryptBASE64([B)Ljava/lang/String;
    ...
    invoke-static {p0, v7}, Lcom/baidu/speech/utils/analysis/Analysis;->buildStatUrl(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v10, v9, v11}, Lcom/baidu/speech/utils/analysis/Analysis;->httpRequest(Ljava/lang/String;Ljava/util/Map;[BZ)Ljava/lang/String;
